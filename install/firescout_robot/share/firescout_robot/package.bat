...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\firescout_robot\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\firescout_robot\hook\ament_prefix_path.bat"
